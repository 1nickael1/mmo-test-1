...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    // Definir melhorias específicas por classe
    const getClassSpecificUpgrades = (
      level: number,
      characterClass: string
    ): Upgrade[] => {
      const baseUpgrades = getBaseUpgrades(level);
      const classUpgrades = getClassUpgrades(level, characterClass);
      return [...baseUpgrades, ...classUpgrades];
    };

    // Melhorias base (disponíveis para todas as classes)
    const getBaseUpgrades = (level: number): Upgrade[] => {
      const baseUpgradesByLevel: Record<number, Upgrade[]> = {
        ...
        8: [
          ...
          },
          {
            ...
            description:
              "Produz materiais automaticamente (+10/hora por nível)",
            level: 1,
            max_level: 5,
        ...
        49: [
          ...
          },
          {
            ...
            upgrade_type: "building",
            upgrade_name:
              "Sistema de Transcendência de Transcendência Absoluta",
    ...
    const getClassUpgrades = (
      level: number,
      characterClass: string
    ): Upgrade[] => {
      const classUpgradesByLevel: Record<string, Record<number, Upgrade[]>> = {
        ninja: {
          1: [
            {
              id: 1001,
              ...
              description:
                "Aumenta a eficiência de habilidades ninja (+10% por nível)",
              level: 1,
              max_level: 10,
          ...
          3: [
            {
              ...
              name: "Dojo Secreto",
              description: "Permite aprender técnicas ninja avançadas",
              level: 1,
              max_level: 5,
              cost: { gold: 500, time_seconds: 120 },
              is_completed: false,
          ...
          5: [
            {
              ...
              description:
                "Aumenta dano de ataques à distância (+15% por nível)",
              level: 1,
              max_level: 5,
          ...
          1: [
            {
              ...
              description:
                "Aumenta resistência em ambientes espaciais (+20% por nível)",
              level: 1,
              max_level: 10,
              cost: { gold: 250, time_seconds: 90 },
              is_completed: false,
          ...
          3: [
            {
              ...
              type: "class_specific",
              upgrade_type: "class_specific",
              upgrade_name: "Estação Espacial",
              name: "Estação Espacial",
              description: "Base espacial para operações avançadas",
              level: 1,
              max_level: 5,
              cost: { gold: 600, time_seconds: 150 },
              is_completed: false,
          ...
          5: [
            {
              ...
              description:
                "Proteção avançada contra radiação e vácuo (+25% por nível)",
              level: 1,
              max_level: 5,
              cost: { gold: 1000, time_seconds: 240 },
              is_completed: false,
          ...
          1: [
            {
              ...
              type: "class_specific",
              upgrade_type: "class_specific",
              upgrade_name: "Círculo Mágico",
              name: "Círculo Mágico",
              description:
                "Aumenta poder das magias elementais (+12% por nível)",
              level: 1,
              max_level: 10,
          ...
          3: [
            {
              ...
              name: "Torre de Magia",
              description: "Centro de pesquisa e prática mágica",
              level: 1,
              max_level: 5,
          ...
          5: [
            {
              ...
              description: "Amplifica energia mágica (+18% por nível)",
              level: 1,
              max_level: 5,
          ...
          1: [
            {
              ...
              type: "class_specific",
              upgrade_type: "class_specific",
              upgrade_name: "Treinamento de Precisão",
              name: "Treinamento de Precisão",
              description:
                "Aumenta precisão e alcance de ataques (+15% por nível)",
              level: 1,
              max_level: 10,
          ...
          3: [
            {
              ...
              type: "class_specific",
              upgrade_type: "class_specific",
              upgrade_name: "Torre de Observação",
              name: "Torre de Observação",
              description: "Permite detectar inimigos a longa distância",
              level: 1,
              max_level: 5,
          ...
          5: [
            {
              ...
              type: "class_specific",
              upgrade_type: "class_specific",
              upgrade_name: "Arsenal de Flechas Mágicas",
              name: "Arsenal de Flechas Mágicas",
              description:
                "Flechas com propriedades especiais (+20% por nível)",
              level: 1,
              max_level: 5,
          ...
          1: [
            {
              ...
              description: "Aumenta poder de cura e proteção (+14% por nível)",
              level: 1,
              max_level: 10,
              cost: { gold: 200, time_seconds: 60 },
              is_completed: false,
          ...
          3: [
            {
              ...
              name: "Templo Sagrado",
              description: "Centro de poder divino e bênçãos",
              level: 1,
              max_level: 5,
          ...
          5: [
            {
              ...
              name: "Escudo Sagrado",
              description: "Proteção divina contra mal (+22% por nível)",
              level: 1,
              max_level: 5,
          ...
          1: [
            {
              ...
              description:
                "Aumenta chance de crítico e evasão (+16% por nível)",
              level: 1,
              max_level: 10,
          ...
          3: [
            {
              ...
              description: "Rede de contatos e informações secretas",
              level: 1,
              max_level: 5,
          ...
          5: [
            {
              ...
              description:
                "Armas envenenadas para ataques furtivos (+24% por nível)",
              level: 1,
              max_level: 5,
      ...
      return classUpgradesByLevel[characterClass]?.[level] || [];
    };
    ...
    for (let level = 1; level <= characterLevel; level++) {
      const upgradesForLevel = getClassSpecificUpgrades(
        ...
        // Verificar se pode pagar pelos recursos
        const canAffordGold =
          (resourceMap.ouro || 0) >= (upgrade.cost.gold || 0);
        const canAffordMaterials =
          (resourceMap.materiais || 0) >= (upgrade.cost.materials || 0);
        const canAffordCrystals =
          (resourceMap.cristais || 0) >= (upgrade.cost.crystals || 0);
        const canAfford =
          canAffordGold && canAffordMaterials && canAffordCrystals;
        ...
        return {
          ...
          can_upgrade:
            !isInProgress && currentLevel < upgrade.max_level && canAfford,
    ...
    for (
      ...
      const upgradesForLevel = getClassSpecificUpgrades(
        ...
        // Verificar se pode pagar pelos recursos (mesmo para melhorias futuras)
        const canAffordGold =
          (resourceMap.ouro || 0) >= (upgrade.cost.gold || 0);
        const canAffordMaterials =
          (resourceMap.materiais || 0) >= (upgrade.cost.materials || 0);
        ...
        return {
          ...
          current_cost: upgrade.cost,
          can_afford: canAfford,
          can_upgrade: false, // Não pode fazer upgrade ainda (nível insuficiente)
          time_seconds: upgrade.cost.time_seconds,
          time_remaining: timeRemaining,
          is_completed: isCompleted,
          is_in_progress: isInProgress,
